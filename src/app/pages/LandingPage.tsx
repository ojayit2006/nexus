      ...
      <div className="w-full lg:w-[55%] bg-white border-r-4 border-[#121212] flex flex-col">
        <nav className="px-8 lg:px-20 py-6 flex items-center justify-between border-b-4 border-[#121212]">
          ...
          <div className="hidden md:flex items-center gap-8">
            <button onClick={() => scrollTo('features')} className="font-bold uppercase text-sm hover:text-[#D02020] cursor-pointer">
              Features
            </button>
            <button onClick={() => scrollTo('pricing')} className="font-bold uppercase text-sm hover:text-[#D02020] cursor-pointer">
              Pricing
            </button>
           ...
           <Link to="/dashboard">
              <BauhausButton variant="red">Dashboard</BauhausButton>
           </Link>
          </div>
        </nav>
        ...
        <div className="flex-1 px-8 lg:px-20 py-16 lg:py-24 flex flex-col justify-center">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <BauhausButton variant="outline" onClick={() => scrollTo('workflow')}>SEE HOW IT WORKS</BauhausButton>
          </div>
        </div>
      </div>
...
function WorkflowSection() {
  ...
  return (
    <section id="workflow" ref={ref} className="py-24 border-b-4 border-[#121212]">
...
function FeaturesGrid() {
  ...
  return (
    <section id="features" className="py-24 border-b-4 border-[#121212]">
      <div className="max-w-7xl mx-auto px-8">
        <h2
          className="font-black text-4xl lg:text-6xl uppercase mb-16"
          style={{ letterSpacing: '-0.04em' }}
      ...
      <div className="max-w-7xl mx-auto px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="text-white">
            ...
            <Link to="/dashboard" className="font-bold uppercase text-sm underline hover:no-underline">
              VIEW DASHBOARD →
            </Link>
          </div>
...
function PaymentSection() {
  return (
    <section id="pricing" className="bg-[#F0C020] border-b-4 border-[#121212] py-24">
      <div className="max-w-7xl mx-auto px-8">
        <h2
